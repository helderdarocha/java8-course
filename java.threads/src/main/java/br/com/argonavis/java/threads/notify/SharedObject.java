...
public class SharedObject {
	...
	public synchronized boolean set(int v) {
		...
		notifyAll(); // avisa a todos os threads (menos eficiente)
		// notify(); // avisa a um thread que espera no objeto (pode ser outro produtor,
		// que não vai poder operar)
		return true;
	}
	...
	public synchronized boolean reset() {
		...
		// notify(); // avisa a um thread que espera no objeto (pode ser outro
		// consumidor, que não vai poder operar)
		return true;
	}
}